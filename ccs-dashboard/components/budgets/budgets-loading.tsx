...
import { TABLE_PANEL_HEIGHT } from "@/components/budgets/budgets-utils"
        ...
        <div className="flex flex-col gap-2 sm:grid sm:grid-cols-[minmax(0,156px)_minmax(0,180px)] lg:flex lg:flex-row lg:items-center">
          ...
          <div className="hidden lg:block">
            <div className="flex items-center">
              ...
              <Skeleton className="h-9 w-[102px] rounded-none border-l-0" />
              <Skeleton className="h-9 w-[110px] rounded-l-none border-l-0" />
            </div>
          </div>
